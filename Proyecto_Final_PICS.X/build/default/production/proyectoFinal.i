...
void tempHumCheck(char chumEnt,char chumDec, char ctempEnt, char ctempDec){
    ...
    if(ctempEnt+(ctempDec/100) < 36.0){
        LATAbits.LA5 = 1;
    }else if(ctempEnt+(ctempDec/100) >38.0)
        LATAbits.LA5 =0;

    if((chumEnt+(chumDec/100) > 60.0) && (dias<=18) ){
        LATAbits.LA6 = 1;
    }else if((chumEnt+(chumDec/100) < 55.0) && (dias<=18)){
        LATAbits.LA6 =0;
    }else if((chumEnt+(chumDec/100) < 63.0) && (dias>18)){
        LATAbits.LA6=0;
...
void iniciarDHT11(void){
    ...
    if(PORTAbits.RA0 == 0 ){
        ...
        if(PORTAbits.RA0 == 1){
            _delay((unsigned long)((75)*(8000000/4000000.0)));
...
void main(void) {
    ...
    while(1){
        ...
        }else if((PORTAbits.RA2 == 0) && (bandera == 1)){
        ...
        }else if(PORTAbits.RA3 == 0 && (bandera == 1 || bandera == 2)){
